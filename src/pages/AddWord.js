...
export default function AddWord() {
  ...
  const initialData = editingWord
    ? {
        ...editingWord,
        tags: editingWord.tags || [], // YENİ: Varsa etiketleri getir
  ...
  const [tagInput, setTagInput] = useState(""); // Etiket inputu için geçici state
    ...
    try {
      ...
      if (data) {
        ...
        setFormData((prev) => ({
          ...prev,
          ...data,
          tags: data.tags || [], // AI'dan gelen etiketleri al
