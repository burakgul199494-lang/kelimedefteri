...
import WordCard from "../components/WordCard"; // WordCard geri geldi
...
export default function Dictionary() {
  ...
  useEffect(() => {
    ...
    setResults(filtered);
    setVisibleCount(PER_PAGE); // Arama değişince sayacı sıfırla
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
            ...
            {displayedResults.length > 0 && (
                <>
                    ...
                    {/* KARTLARI GÖSTER (WordCard kullanıyoruz) */}
