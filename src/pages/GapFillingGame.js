    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center p-4">
       <div className="w-full max-w-md space-y-4 mt-2">
          ...
          <div className="bg-white p-6 rounded-3xl shadow-xl border border-slate-100 text-center space-y-6 relative overflow-hidden min-h-[450px] flex flex-col justify-between">
                        ...
                        <div className="flex gap-2">
                            ...
                            {turkishDefinition && (
                                <button 
                                  ...
                                  style={{ WebkitTapHighlightColor: 'transparent' }}
                                  className={`p-2 border border-slate-200 rounded-lg transition-colors focus:outline-none ${showHintTr ? "bg-indigo-100 text-indigo-600 border-indigo-200" : "bg-white text-slate-400 hover:text-indigo-600"}`}
                                >
             ...
             {/* 3. KARIŞIK HARFLER (YENİ SÖZLÜK BUTON STİLİ) */}
