  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center p-4">
       ...
       <div className="w-full max-w-md space-y-4 mt-2">
          ...
          <div className="bg-white p-6 rounded-3xl shadow-xl border border-slate-100 text-center space-y-6 relative overflow-hidden min-h-[450px] flex flex-col justify-between">
             ...
             <div className="space-y-4 mt-2">
               ...
               <div className="flex flex-col items-center gap-3">
                   ...
                   {/* CÜMLE OKUMA BUTONU (SÖZLÜK TASARIMI - BLUR EKLENDİ) */}
                   <button 
                       onClick={(e) => { 
                           handleBlur(e);
                 ...
                 <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 text-sm text-slate-600 mt-2 text-left shadow-sm">
                    <div className="flex items-center justify-between gap-2 mb-2">
                        ...
                        <div className="flex gap-2">
                            {/* İPUCU SES BUTONU (SÖZLÜK TASARIMI - BLUR EKLENDİ) */}
                            <button 
                                onClick={(e) => {
                                    handleBlur(e);
                                ...
                                className={`
                                  p-2 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors focus:outline-none focus:ring-0
                                  ${activeAudio === 'hint' ? 'text-red-500 border-red-200' : 'text-slate-400 hover:text-indigo-600'}
                                `}
                            >
                                {activeAudio === 'hint' ? <Square className="w-4 h-4 fill-current"/> : <Volume2 className="w-4 h-4"/>}
                            </button>

                            {/* ÇEVİRİ BUTONU (SÖZLÜK TASARIMI - BLUR EKLENDİ) */}
                            {turkishDefinition && (
                                <button 
                                  onClick={(e) => {
                                      handleBlur(e);
                  ...
                  return (
                    <div 
                      ...
                      className={`
                        ...
                        ${char ? "border-indigo-500 text-indigo-700 bg-indigo-50 translate-y-0" : "border-slate-200 bg-slate-50 text-transparent"}
                      `}
                    >
                      {char || "_"}
                    </div>
             ...
             {/* 3. KARIŞIK HARFLER (BUTONLAR - BLUR EKLENDİ) */}
                ...
                {shuffledLetters.map((item) => (
                  <button
                    ...
                    className={`
                      ...
                      transition-all duration-75 select-none focus:outline-none focus:ring-0
                      ${item.isUsed 
             ...
             {/* 4. KONTROL BUTONLARI (İpucu) - BLUR EKLENDİ */}
          ...
          <button onClick={handleQuitEarly} className="w-full text-center text-slate-400 hover:text-red-500 text-sm font-medium transition-colors focus:outline-none">
            Bitir ve Çık
          </button>
