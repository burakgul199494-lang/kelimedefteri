          ...
          <div className="bg-white p-6 rounded-3xl shadow-xl border border-slate-100 text-center space-y-6 relative overflow-hidden min-h-[450px] flex flex-col justify-between">
             ...
             <div className="space-y-4 mt-2">
               ...
               <div className="flex flex-col items-center gap-3">
                   ...
                   {/* CÜMLE OKUMA BUTONU (SÖZLÜK TARZI: SADECE SES) */}
                   <button 
                       onClick={() => handleSpeak(currentWordObj.sentence, 'sentence')} 
                       style={{ WebkitTapHighlightColor: 'transparent', outline: 'none' }}
                       className={`
                         flex items-center justify-center gap-2 px-4 py-2 rounded-full border transition-all duration-200
                   ...
                   >
                       ...
                       <span className="text-xs font-bold">Cümleyi Oku</span>
                   </button>
               </div>
                 ...
                 <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 text-sm text-slate-600 mt-2 text-left shadow-sm">
                    <div className="flex items-center justify-between gap-2 mb-2">
                        ...
                        <div className="flex gap-2">
                            {/* İPUCU SES BUTONU (SÖZLÜK TARZI: SADE) */}
                            <button 
                                onClick={() => handleSpeak(englishDefinition, 'hint')} 
                                style={{ WebkitTapHighlightColor: 'transparent', outline: 'none' }}
                                className={`
                                  p-2 rounded-full border flex items-center justify-center transition-colors duration-200
                                  focus:outline-none focus:ring-0
                                  ${activeAudio === 'hint'
                                ...
                                `}
                            >
                                {activeAudio === 'hint' ? <Square className="w-3.5 h-3.5 fill-current"/> : <Volume2 className="w-3.5 h-3.5"/>}
                            </button>

                            {/* ÇEVİRİ BUTONU (SÖZLÜK TARZI: AÇIKKEN MAVİ) */}
                            {turkishDefinition && (
                                <button 
                                  ...
                                  className={`
                                    ...
                                    focus:outline-none focus:ring-0
                                    ${showHintTr 
                                        ? "bg-indigo-600 text-white border-indigo-600" // AÇIK: Mavi
                                        : "bg-white text-slate-400 border-slate-200 hover:text-indigo-600" // KAPALI: Beyaz
                                    }
                                  `}
                                >
             ...
             <div className="flex flex-wrap justify-center gap-2 content-center">
                {shuffledLetters.map((item) => (
                  <button
                    ...
                    style={{ WebkitTapHighlightColor: 'transparent', outline: 'none' }}
                    className={`
                      w-11 h-12 md:w-12 md:h-14 rounded-xl font-bold text-lg border-2 shadow-sm transition-all duration-100 select-none
                      ...
                      ${item.isUsed 
                          ...
                          : wrongAnimationId === item.id 
                              ...
                              : "bg-white text-slate-700 border-slate-200 active:scale-95 active:bg-slate-50 hover:border-indigo-200 hover:text-indigo-600"
                      }
                    `}
                  >
                    {item.char}
