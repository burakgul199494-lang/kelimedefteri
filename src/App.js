        ...
        <div className="w-full max-w-md space-y-8 mt-4">
          ...
          <div className="text-center relative">
            ...
            <button 
                ...
                className="absolute left-15 top-0 p-2 bg-white rounded-full shadow-sm border border-slate-200 text-slate-400 hover:text-red-500 z-50 transition-transform active:scale-90" 
            ...
            <button 
                ...
                className="absolute right-15 top-0 p-2 bg-white rounded-full shadow-sm border border-slate-200 text-slate-400 hover:text-red-500 z-50 transition-transform active:scale-90"
                title="Çıkış Yap">
                <LogOut size={18} />
            </button>
