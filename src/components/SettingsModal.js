...
import { auth, requestNotificationPermission } from "../services/firebase"; // Bildirim fonksiyonunu çektik
...
export default function SettingsModal({ onClose }) {
  ...
  // Sıfırlama (Senin mevcut fonksiyonun)
  const handleReset = async () => {
    if (window.confirm("TÜM ilerlemen ve istatistiklerin silinecek! Emin misin?")) {
      await resetProfile();
      alert("Profil sıfırlandı.");
      onClose();
    }
  };
